...
public class TerrorZones
{
    ...
    public void RunScript()
    {
        ...
        if (Form1_0.Town_0.GetInTown())
        {
            ...
            else if (TerrorZonesAreas[CurrentTerrorZonesIndex] == Area.StonyField)
            {
                Form1_0.SetGameStatus("DOING TZ Stony Field");
                ...
                else if (TerrorZonesAreas[CurrentTerrorZonesIndex] == Area.InnerCloister)
                {
                    Form1_0.SetGameStatus("DOING TZ Cathedral");
                    Form1_0.Town_0.GoToWPArea(1, 7);
                    //Form1_0.Battle_0.CastDefense();
                    //Form1_0.WaitDelay(15);
                    Form1_0.PathFinding_0.MoveToNextArea(Enums.Area.Cathedral);

                    if ((Enums.Area)Form1_0.PlayerScan_0.levelNo == Enums.Area.Cathedral)
                    {
                        Form1_0.WaitDelay(15);
                        Form1_0.Battle_0.CastDefense();
                        Form1_0.WaitDelay(100);
                ...
                if (Form1_0.PlayerScan_0.levelNo == (int)Enums.Area.Cathedral)
                ...
                else if (TerrorZonesAreas[CurrentTerrorZonesIndex] == Area.LostCity)
                {
                    Form1_0.Town_0.GoToWPArea(2, 5);


                    Form1_0.SetGameStatus("DOING TZ Lost City");
                    //Form1_0.Battle_0.CastDefense();
                    //Form1_0.WaitDelay(15);
                ...
                else if (TerrorZonesAreas[CurrentTerrorZonesIndex] == Area.GreatMarsh)
                {
                    Form1_0.Town_0.GoToWPArea(3, 2);
                ...
                //######################
                //ACT 5
                else if (TerrorZonesAreas[CurrentTerrorZonesIndex] == Area.BloodyFoothills)

                    Form1_0.PathFinding_0.MoveToNextArea(Enums.Area.BloodyFoothills);
                ...
                else if (TerrorZonesAreas[CurrentTerrorZonesIndex] == Area.TheWorldStoneKeepLevel1)
                {
                    Form1_0.Town_0.GoToWPArea(5, 7);
                    Form1_0.PathFinding_0.MoveToExit(Enums.Area.TheAncientsWay);
                ...
                else if (TerrorZonesAreas[CurrentTerrorZonesIndex] == Area.TheWorldStoneKeepLevel2)
                {
                    Form1_0.Town_0.GoToWPArea(5, 7);
                    Form1_0.PathFinding_0.MoveToExit(Enums.Area.TheAncientsWay);
                    Form1_0.PathFinding_0.MoveToExit(Enums.Area.ArreatSummit);
                ...
                else if (TerrorZonesAreas[CurrentTerrorZonesIndex] == Area.TheWorldStoneKeepLevel3)
                {
                    Form1_0.Town_0.GoToWPArea(5, 7);
                    Form1_0.PathFinding_0.MoveToExit(Enums.Area.TheAncientsWay);
                    Form1_0.PathFinding_0.MoveToExit(Enums.Area.ArreatSummit);
                ...
                else if (TerrorZonesAreas[CurrentTerrorZonesIndex] == Area.ThroneOfDestruction)
                {
                    Form1_0.Town_0.GoToWPArea(5, 7);
                    Form1_0.PathFinding_0.MoveToExit(Enums.Area.TheAncientsWay);
                    Form1_0.PathFinding_0.MoveToExit(Enums.Area.ArreatSummit);
